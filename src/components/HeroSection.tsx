...
const HeroSection = ({ onCtaClick }: HeroSectionProps) => {
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-yellow-50 via-yellow-100 to-yellow-200 overflow-hidden">
      {/* Background decorative elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/4 left-1/4 w-72 h-72 bg-yellow-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-float"></div>
        <div className="absolute top-3/4 right-1/4 w-96 h-96 bg-yellow-300 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-float" style={{animationDelay: '2s'}}></div>
        <div className="absolute bottom-1/4 left-1/3 w-64 h-64 bg-yellow-400 rounded-full mix-blend-multiply filter blur-xl opacity-25 animate-float" style={{animationDelay: '4s'}}></div>
      </div>
          ...
          <div className="text-center lg:text-left animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button 
                onClick={onCtaClick}
                size="lg" 
                className="bg-yellow-600 hover:bg-yellow-700 text-white px-8 py-4 text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
              >
            ...
            <div className="relative mx-auto w-80 h-80 lg:w-96 lg:h-96">
              ...
              <div className="absolute inset-0 bg-gray-900 rounded-3xl shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500">
                <div className="absolute inset-2 bg-white rounded-2xl overflow-hidden">
                  ...
                  <div className="bg-yellow-600 h-16 flex items-center px-4">
                  ...
                  <div className="p-4 space-y-3 bg-gray-50 h-full">
                    ...
                    <div className="bg-yellow-500 text-white p-3 rounded-lg shadow-sm max-w-xs ml-auto">
                      <p className="text-sm">Gostaria de saber sobre os produtos</p>
                      <span className="text-xs text-yellow-200">09:31</span>
                    </div>
              ...
              {/* Floating elements */}
              <div className="absolute -top-4 -right-4 bg-yellow-500 text-white p-3 rounded-xl shadow-lg animate-float">
