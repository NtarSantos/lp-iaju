...
const HeroSection = ({ onCtaClick }: HeroSectionProps) => {
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/10 via-primary/20 to-primary/30 overflow-hidden">
      {/* Background decorative elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/4 left-1/4 w-72 h-72 bg-primary/20 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-float"></div>
        <div className="absolute top-3/4 right-1/4 w-96 h-96 bg-primary/30 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-float" style={{animationDelay: '2s'}}></div>
        <div className="absolute bottom-1/4 left-1/3 w-64 h-64 bg-primary/40 rounded-full mix-blend-multiply filter blur-xl opacity-25 animate-float" style={{animationDelay: '4s'}}></div>
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-fade-in">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold text-secondary-foreground mb-6 leading-tight">
              Atendimento Inteligente e{" "}
              <span className="text-primary relative">
                24/7
                <div className="absolute -bottom-2 left-0 right-0 h-1 bg-primary/50 rounded-full"></div>
              </span>{" "}
              para o seu WhatsApp
            </h1>
          ...
          <div className="relative animate-fade-in" style={{animationDelay: '0.3s'}}>
            <div className="relative mx-auto w-80 h-80 lg:w-96 lg:h-96">
              ...
              <div className="absolute inset-0 bg-gray-900 rounded-3xl shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500">
                <div className="absolute inset-2 bg-white rounded-2xl overflow-hidden">
                  ...
                  <div className="p-4 space-y-3 bg-gray-50 h-full">
                    ...
                    <div className="bg-primary text-primary-foreground p-3 rounded-lg shadow-sm max-w-xs ml-auto">
                      <p className="text-sm">Gostaria de saber sobre os produtos</p>
                      <span className="text-xs text-primary-foreground/70">09:31</span>
                    </div>
              ...
              {/* Floating elements */}
              <div className="absolute -top-4 -right-4 bg-primary text-primary-foreground p-3 rounded-xl shadow-lg animate-float">
